...
namespace Unclazz.Parsec
{
    ...
    public static class ParserExtension
    {
        ...
        /// </para>
        /// </summary>
        /// <typeparam name="T">読み取り結果を変換した後の型</typeparam>
        /// <param name="self">レシーバー</param>
        /// <param name="transform">変換を行う関数</param>
        /// <returns>新しいパーサー</returns>
        public static Parser<T> Map<T>(this Parser<char> self, Func<string, T> transform)
        {
            return new MapParser<string, T>(self.Capture(), transform);
        }
        /// <summary>
