...
namespace Unclazz.Parsec
{
    ...
    public static class Parsers
    {
        ...
        /// <returns>新しいパーサー</returns>
        public static Parser<T> For<T>(Func<Reader, ParseResult<T>> func) => _factory.For(func);
        /// <summary>
        /// デリゲートをもとにパーサーを生成します。
        /// </summary>
        /// <param name="func">パースの実処理を行うデリゲート</param>
        /// <returns>新しいパーサー</returns>
        public static Parser For(Func<Reader, ParseResult<Nil>> func) => _factory.For(func);
        /// <summary>
